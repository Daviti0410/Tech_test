...
const meetings_schema_1 = require("./meetings.schema");
const sub_code_review_module_1 = require("../sub-code-review/sub-code-review.module");
const sub_code_review_schema_1 = require("../sub-code-review/sub-code-review.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: 'Meeting', schema: meetings_schema_1.MeetingSchema },
